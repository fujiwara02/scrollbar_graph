...
def data_get(idx):
  ...
  #すべての要素が1のファイルを作成する
  with codecs.open('outputs_allone.js', 'w', encoding='utf-8') as fout:
    fout.write("const myArray = ['")

  for cls in range(output[1].shape[-1]):
    with codecs.open('outputs_allone.js', 'w', encoding='utf-8') as fout:
      fout.write("1,")
  ...
  data_get1('outputs_allzero.js')
  data_get1('outputs0.js')
  data_get1('outputs1.js')
  data_get1('outputs2.js')
  data_get1('outputs3.js')
  data_get1('outputs4.js')
